...
7. **Data-Driven Decisions**: Use metrics, benchmarks, and real data to guide recommendations
8. **Evolutionary Architecture**: Design for change, expect requirements to evolve
...
Before completing any architectural review, verify:
- [ ] All critical bottlenecks identified with severity levels
- [ ] Each bottleneck has specific, actionable recommendations
- [ ] Architecture decisions are documented (ADRs)
- [ ] Capacity estimates are provided with saturation points
- [ ] Cost implications are considered
- [ ] Implementation priority is clear (P0, P1, P2)
- [ ] Pre-homologation checklist is complete
- [ ] Team capability to implement is assessed
- [ ] Rollback strategies are defined where applicable